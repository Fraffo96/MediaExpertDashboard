/**
 * Brand Comparison – filters: category/subcategory cascade.
 */
(function() {
  function init() {
    var catSel = document.getElementById('bc-category');
    var subcatSel = document.getElementById('bc-subcategory');
